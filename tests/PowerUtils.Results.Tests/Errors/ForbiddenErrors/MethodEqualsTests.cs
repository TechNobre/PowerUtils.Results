...
namespace PowerUtils.Results.Tests.Errors.ForbiddenErrors
{
    public class MethodEqualsTests
    {
        ...
        public void Null_Equals_False()
        {
            ...
            IError error = Error.Forbidden(property, code, description);
        ...
        public void DifferentProperty_Equals_False()
        {
            ...
            IError error = Error.Forbidden(property, code, description);
            IError other = Error.Forbidden("fake", code, description);
        ...
        public void DifferentCode_Equals_False()
        {
            ...
            var other = Error.Forbidden(property, "fake", description);
        ...
        public void DifferentDescription_Equals_False()
        {
            ...
            IError error = Error.Forbidden(property, code, description);
            IError other = Error.Forbidden(property, code, "fake");
        ...
        public void BothObjectsFromError_Equals_True()
        {
            ...
            object error = Error.Forbidden(property, code, description);
            object other = Error.Forbidden(property, code, description);
