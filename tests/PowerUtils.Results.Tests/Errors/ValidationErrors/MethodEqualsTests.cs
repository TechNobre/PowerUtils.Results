...
namespace PowerUtils.Results.Tests.Errors.ValidationErrors
{
    public class MethodEqualsTests
    {
        ...
        public void Null_Equals_False()
        {
            ...
            IError error = Error.Validation(property, code, description);
        ...
        public void DifferentProperty_Equals_False()
        {
            ...
            IError error = Error.Validation(property, code, description);
            IError other = Error.Validation("fake", code, description);
        ...
        public void DifferentCode_Equals_False()
        {
            ...
            IError error = Error.Validation(property, code, description);
            IError other = Error.Validation(property, "fake", description);
        ...
        public void DifferentDescription_Equals_False()
        {
            ...
            IError error = Error.Validation(property, code, description);
            IError other = Error.Validation(property, code, "fake");
        ...
        public void AllPropertiesEquals_Equals_True()
        {
            ...
            IError error = Error.Validation(property, code, description);
            IError other = Error.Validation(property, code, description);
        ...
        public void BothObjectsFromError_Equals_True()
        {
            ...
            object error = Error.Validation(property, code, description);
            object other = Error.Validation(property, code, description);
