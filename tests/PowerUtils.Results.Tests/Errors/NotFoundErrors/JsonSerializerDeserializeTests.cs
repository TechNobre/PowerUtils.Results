...
namespace PowerUtils.Results.Tests.Errors.NotFoundErrors
{
    ...
    {
        [Fact]
        public void EmptyArrayString_DeserializeToIErrorList_EmptyNotFoundErrorList()
        {
            // Arrange
            var serialization = "[]";
            ...
            // Act
            var act = JsonSerializer.Deserialize<List<NotFoundError>>(serialization);
            ...
            {
                act.Should().BeEmpty();
                act.Should().BeOfType<List<NotFoundError>>();
            }
        }

        [Fact]
        public void EmptyArrayString_DeserializeToIErrorArray_EmptyNotFoundErrorArray()
        {
            // Arrange
            var serialization = "[]";
            ...
            // Act
            var act = JsonSerializer.Deserialize<NotFoundError[]>(serialization);
            ...
            {
                act.Should().BeEmpty();
                act.Should().BeOfType<NotFoundError[]>();
            }
        }

        [Fact]
        public void String_Deserialize_NotFoundError()
        {
            // Arrange
            var json = @"{
            ...
            // Act
            var act = JsonSerializer.Deserialize<NotFoundError>(json);
        ...
        [Fact]
        public void NotFoundError_SerializeDeserialize_SameOriginalError()
        {
            // Arrange
            var property = "prop";
            var code = "cod";
        ...
        [Fact]
        public void NotFoundError_DeserializeUsingIError_SameOriginalError()
        {
            ...
            var serialization = JsonSerializer.Serialize(
                Error.NotFound(property, code, description));
